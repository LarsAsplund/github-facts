...
[`visualize_test_strategy.py`](https://(ref:repoTree)/py/analyze_test_strategy.py) creates the figures used in this post from the results generated by `analyze_test_strategy.py` (\@ref(analyze-test-strategy)). The figures are saved to the output directory given in the call.
